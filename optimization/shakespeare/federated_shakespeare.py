...
def run_federated(
  ...
  Args:
    iterative_process_builder: A function that accepts a no-arg `model_fn`, and
      ...
      `model_fn` must return a `Union[tff.learning.models.VariableModel, tff.learning.models.FunctionalModel, tff.learning.models.ReconstructionModel]`.
  ...
  try:
    ...
    q_client = np.load(f'/home/monica/AVAIL_VECTORS/q_client_{var}_shakespeare.npy')
  except:
